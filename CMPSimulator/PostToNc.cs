...
namespace CMPSimulator
{
    public class PostToNc
    {
		...
		public string SignOrEncrypt(string Url, string PackageSrc, int lnsign)
        {
            ...
            {                
                ...
                myHttpWebRequest.Method = "post";
                //myHttpWebRequest.Connection = "close";  // 这句代码报错
                //myHttpWebRequest.ContentType = "application/x-www-form-urlencoded";   原代码是这样
                myHttpWebRequest.ContentType = "application/x-www-form-urlencoded;charset=gbk";  // 杭研吴老师，建议加上 charset=gbk
